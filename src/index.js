...
function addSecurityHeaders(response) {
	...
	response.headers.set('Content-Security-Policy', "default-src 'self'; script-src 'self' https://cloud.umami.is https://us-assets.i.posthog.com; style-src 'self' 'unsafe-inline' https://cdn.jsdelivr.net; font-src 'self' https://cdn.jsdelivr.net; img-src 'self' data:; connect-src 'self' https://cloud.umami.is https://us.i.posthog.com; frame-src https://www.google.com; frame-ancestors 'none'");
}
